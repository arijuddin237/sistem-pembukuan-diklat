...
$tanggal_jadwal=$_REQUEST['tanggal_jadwal'];
$waktu=$_REQUEST['waktu'];
$topik=$_REQUEST['topik'];
$jumlah_jam=$_REQUEST['jumlah_jam'];
$kirim=$_REQUEST['simpan'];
if (!$kirim){
$qry="select*from jadwal where id_diklat='$id_diklat'";
...
<!--End Navigasi-->
 ...
 <table width="711" border="0" cellpadding="0" cellspacing="0">
    <td height="31" colspan="3" valign="top"><div align="center" class="sukses">
        <p align="center" class="style4">FORM JADWAL</p>
    </div></td>
    </table>
...
<table width="711" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td colspan="7" valign="top"><label>
      : 
      <input type="text" name="nama_diklat" id="nama_diklat" value="<?php echo $nama_diklat; ?>">
      </label></td>
    <td></td>
    </tr>
  <tr>
    <td height="52"></td>
    <td colspan="3" valign="top"><p>ID Diklat</p></td>
    <td></td>
    <td colspan="7" valign="top"><label>
      :
      <input type="text" name="id_diklat" id="id_diklat" value="<?php echo $id_diklat; ?>">
      </label></td>
    <td></td>
    </tr>
  ...
  <tr>
    <td height="55"></td>
    <td colspan="3" valign="top">Tanggal</td>
    <td></td>
    <td valign="top"><label>
      :
    ...
    <td>&nbsp;</td>
    <td colspan="2" valign="top"><select name="bulan" id="bulan">
    ...
    <td>&nbsp;</td>
    <td colspan="2" valign="top"><input name="tahun" type="text" id="taahun" size="4" maxlength="4" /></td>
    <td>&nbsp;</td>
    </tr>
  ...
  <tr>
    ...
    <td colspan="6" valign="top"><label>
      : 
      <input type="text" name="waktu" id="waktu" value="<?php echo $row[3]; ?>"/>
        </label></td>
    <td>&nbsp;</td>
    <td></td>
    </tr>
  <tr>
    <td height="48"></td>
    <td colspan="3" valign="top">Topik dan Kegiatan</td>
    <td></td>
    <td colspan="6" valign="top"><label>
      : 
  ...
  <tr>
    <td height="52"></td>
    <td colspan="3" valign="top">Jumlah Jam</td>
    <td></td>
    <td colspan="6" valign="top"><label>
      : 
      <input type="text" name="jumlah_jam" id="jumlah_jam" value="<?php echo $row[5]; ?>"/>
        </label></td>
    <td></td>
    <td></td>
    </tr>
  ...
  <tr>
    <td height="41"></td>
    <td colspan="3" valign="top">Instruktur</td>
    <td></td>
    <td colspan="6" valign="top"><label>
      : 
  ...
  <tr>
    <td height="47"></td>
    <td colspan="3" valign="top">Instruktur 2</td>
    <td></td>
    <td colspan="6" valign="top"><label>
      : 
  ...
  <tr>
    ...
    <td colspan="2" valign="top"><label>
      <input type="text" name="tanggal_jadwal" id="tanggal_jadwal" value="<?php echo $tanggal_jadwal; ?>">
    </label>
      </td>
    <td></td>
    <td></td>
...
$instruktur2=$_POST["instruktur2"];
$tanggal=$_POST['tanggal'];
$bulan=$_POST['bulan'];
$tahun=$_POST['tahun'];

$perintah="UPDATE jadwal set id_diklat='$id_diklat', nama_diklat='$nama_diklat', tanggal='$tahun-$bulan-$tanggal',waktu='$waktu',topik_dan_kegiatan='$topik', jumlah_jam='$jumlah_jam', instruktur='$instruktur', instruktur2='$instruktur2' where id_diklat='$id_diklat' AND tanggal='$tanggal_jadwal'";
$hasil=mysql_query($perintah);
echo $perintah;
if ($hasil){
	echo "instruksi sukses !<br>";
	echo "<a href=\"cari_jadwal.php\">tampil jadwal</a>";
}
else{
	echo "instruksi gagal !";
	echo "<a href=\"cari_jadwal.php\">edit kembali</a>";
}
}
?>
</html>
