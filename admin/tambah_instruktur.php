...
<table>
<td colspan="5" valign="top"><div align="center" class="sukses style6">Form Input Instruktur</div></td>
</table>
...
$perintah="insert into instruktur values('$nik','$nama')";
$hasil=mysql_query($perintah);
if ($hasil){
	echo "Anda berhasil menambahkan instruktur";
	}
else{
	echo "Anda gagal menambahkan instruktur";
	}
}
 ?>
<!--End Konten-->
