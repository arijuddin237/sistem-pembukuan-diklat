...
<table width="860" border="1" cellpadding="0" cellspacing="0">
  ...
  ?> 
  <tr>
    <td width="249" height="23" valign="top" bgcolor="#FF6666"><div align="center" class="style1 style2"><font face="Geneva, Arial, Helvetica, sans-serif">ID Materi</font></div></td>
  ...
  <tr> 
    ...
    <td width="158" valign="top"><a href="edit_materi.php?id_materi=<?php echo $brs[0];?>"><font face="Geneva, Arial, Helvetica, sans-serif"><center>
      <p><img src="../images/img/update.png" width="22" height="22"></p>
      </center>
    </font></a></td>
    <td width="131" valign="top"><a href="hapusmateri.php?id_materi=<?php echo $brs[0];?>"><font face="Geneva, Arial, Helvetica, sans-serif"><center>
 ...
 <table width="254">
  ...
  <tr>
    ...
    <td valign="top"  bgcolor="#009999"><div align="center">
      <p><a href="tambah_materi.php" title="Tambah Data" class="style8"><img src="../images/icon/tests64.png" width="16" height="16"><span class="style2"> Tambah Data</span></a></p>
